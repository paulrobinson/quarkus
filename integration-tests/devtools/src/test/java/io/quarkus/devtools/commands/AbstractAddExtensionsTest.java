...
abstract class AbstractAddExtensionsTest<T> extends PlatformAwareTestBase {
    ...
    void testPartialMatches() throws Exception {
        createProject();
        addExtensions(asList("mongodb-pana", "hibernate-val", "arc"));
    ...
    void testRegexpMatches() throws Exception {
        ...
        hasDependency(project, "quarkus-smallrye-graphql");
        ...
        hasDependency(project, "quarkus-smallrye-reactive-messaging-mqtt");
